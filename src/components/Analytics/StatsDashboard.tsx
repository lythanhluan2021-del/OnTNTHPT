  ...
  return (
    <div className="space-y-5 pb-24 max-w-md mx-auto px-1">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="p-3.5 rounded-neu bg-[#e6ecf5] shadow-neu-flat space-y-1">
        ...
        <div className="p-3.5 rounded-neu bg-[#e6ecf5] shadow-neu-flat space-y-1">
          ...
          <p className="text-[11px] text-slate-500">Tập trung suy luận</p>
        </div>
        ...
        <div className="p-3.5 rounded-neu bg-[#e6ecf5] shadow-neu-flat space-y-1">
          ...
          <p className="text-[11px] text-slate-500">Không bỏ cuộc</p>
        </div>
        ...
        <div className="p-3.5 rounded-neu bg-[#e6ecf5] shadow-neu-flat space-y-1">
          ...
          <p className="text-[11px] text-slate-500">Dựa theo chuẩn THPT</p>
        </div>
      </div>
      ...
      <div className="p-4 rounded-neu bg-[#e6ecf5] shadow-neu-flat space-y-3">
        ...
        {weakTopics.length === 0 ? (
          <div className="p-4 text-center rounded-neu-sm bg-[#e6ecf5] shadow-neu-inset-sm space-y-2">
          ...
          <div className="space-y-3 pt-1">
            {weakTopics.map((topic) => (
              <div
                key={topic.topicId}
                className="p-3 rounded-neu-sm bg-[#e6ecf5] shadow-neu-inset-sm space-y-2 border-l-4 border-amber-500"
              >
                ...
                <button
                  ...
                  className="w-full py-1.5 px-2 rounded-neu-sm bg-[#e6ecf5] shadow-neu-flat-xs active:shadow-neu-inset text-blue-700 text-xs font-bold flex items-center justify-center gap-1.5 hover:text-blue-800"
                >
            ...
            {attempts
              ...
              .map((attempt) => {
                ...
                return (
                  <div
                    key={attempt.id}
                    className="p-2.5 rounded-neu-sm bg-[#e6ecf5] shadow-neu-flat-xs flex items-center justify-between text-xs"
                  >
                    <div>
